...
class CFOAgent(BaseAgent):
    """The CFO Agent responsible for financial modeling and cost estimation."""
    
    def __init__(self, llm_service: LLMService):
        super().__init__(name="CFO", role_description="Chief Financial Officer")
        self.llm_service = llm_service
        self.prompt_path = os.path.join(os.path.dirname(__file__), "..", "prompts", "cfo.md")
